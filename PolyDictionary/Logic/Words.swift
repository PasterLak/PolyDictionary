...
public class Words {
    ...
    public static let WordsDictionary: [WordModel] = [
        WordModel(word: ["English": "Apple", "German": "Apfel", "Russian": "Яблоко"], percentage: Int8.random(in: 1...100), tags: ["fruit", "fresh", "tropical"]),
        WordModel(word: ["English": "Banana", "German": "Banane", "Russian": "Банан"], percentage: Int8.random(in: 1...100), tags: ["fruit", "fresh", "sweet"]),
